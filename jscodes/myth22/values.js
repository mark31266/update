           ...
           var SIDinput = document.getElementById('SID'); 
             ...
             //-----------------------------------------String to Date Function-------------------------------//
               ...
               doc.get().then((docSnapshot) => {
                 ...
                 db.collection("patientvalues").doc(idSTRING + " Mythic 22").collection("DATE").doc(DATEinput.innerText).collection("SID").doc(SIDinput.innerText).set(
                   {
                   id : idSTRING
                   })
                   db.collection("patientvalues").doc(idSTRING + " Mythic 22").collection("DATE").doc(DATEinput.innerText).set(
                   {
                     id : idSTRING
                   })
                 
                   db.collection("patientvalues").doc(idSTRING + " Mythic 22").set(
                     {
                       id : idSTRING
                     })
